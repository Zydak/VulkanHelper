...
namespace VulkanHelper
{
    ...
    {
    public:
        [[nodiscard]] static Expected<UniquePtr<Impl>, VHResult> New(const PushConstant::Config& config);
        ...
        [[nodiscard]] inline static Impl* GetImplementation(const PushConstant* publicInterface) 
        { 
